 ...
 */
export declare function isProviderName(name: string): boolean;
/**
 ...
 */
export declare function hookFamily(name: string): string | null;
/**
 ...
 */
export declare function isHookName(name: string | null): name is string;
